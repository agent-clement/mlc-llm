...
export TVM_CUDA_USE_ASYNC_ALLOC="${TVM_CUDA_USE_ASYNC_ALLOC:-1}"
export MLC_DEFER_CPU_TOKEN_BURST="${MLC_DEFER_CPU_TOKEN_BURST:-1}"
export MLC_DECODE_BURST_STEPS="${MLC_DECODE_BURST_STEPS:-16}"
export MLC_STABLE_DECODE_EMBEDDING="${MLC_STABLE_DECODE_EMBEDDING:-1}"

exec "$CONDA_ENV/bin/python" "$SCRIPT_DIR/run_im.py" "$@"
