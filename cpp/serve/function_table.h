...
struct FunctionTable {
  ...
  Function kv_cache_get_query_positions_func_;
  Function gpu_multinomial_from_uniform_func_;
  Function gpu_argmax_logits_func_;
