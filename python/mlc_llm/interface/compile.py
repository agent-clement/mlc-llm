...
def _compile(args: CompileArgs, model_config: ConfigBase):
    ...
    with args.target:
        ...
        cuda_graph_symbolic_capture_hints = {
            ...
            "batch_decode_mrope": ["batch_size"],
            "batch_decode_mrope_to_last_hidden_states": ["batch_size"],
            "batch_verify": ["batch_size", "seq_len"],
            "batch_verify_to_last_hidden_states": ["batch_size", "seq_len"],
            "batch_verify_mrope": ["batch_size", "seq_len"],
            "get_logits": ["batch_size", "seq_len"],
            "batch_get_logits": ["batch_size", "seq_len"],
        }
