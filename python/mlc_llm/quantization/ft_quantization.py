            ...
            def visit_module(self, name: str, node: nn.Module) -> Any:
                ...
                if isinstance(node, nn.Linear):
                    ...
                    if (
                        ...
                        or (self.config.quantize_dtype == "int4" and node.out_features % 64 != 0)
                        or (self.config.quantize_dtype == "int8" and node.out_features % 32 != 0)
                    ):
                        ...
                        # CUTLASS preprocessing requires packed rows/cols to be 32-byte aligned.
                        logger.info(
